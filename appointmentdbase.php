...
<div class="appointment-form">
    <form name="forminfo" action="process_appointment.php" method="post">
        ...
        <div class="service-section">
            ...
            <select name="service" id="service" class="service" onchange="getPrice()">
                ...
                <option value="Haircut (Trim)">Haircut (Trim)</option>
        ...
        <div class="date-section">
            <label>Date: </label>
            <input type="date" id="date" name="appointment_date" onchange="addTime()">
        </div>
        
        <div class="time-section">
            <label>Time: </label>
            <select name="appointment_time" id="time" class="time">
            </select>
        </div>
        ...
        <div class="contact-info">
            ...
            <div class="contactno-section">
                <label>Contact #: </label>
                <input type="tel" name="contact_number" required></input>
            </div>
        ...
        <script>
            ...
            prices["Haircut (Male)"] = "499"
            prices["Haircut (Female)"] = "599"
            prices["Haircut (Child)"] = "399"
            prices["Haircut (Trim)"] = "299"
